...
from nets.HRnet_fam_ThreeAttention import get_net as HRnet_fam_mam
...
if __name__ == "__main__":
    ...
    model = HRnet_fam_mam(config,mode=1)
    ...
    loss_history = LossHistory("logs/fam_mam")
