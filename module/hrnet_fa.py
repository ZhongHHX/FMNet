...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        #最后的384 通道到 720通道
        self.up_channels = nn.Conv2d(384,720,kernel_size=1,stride=1,padding=0)
    ...
    def Feature_Align(self,input=None):  # list: input
        ...
        # while idx != 0:
        #
        #     in_ch = big_map.size()[1]
        #     out_ch = small_map.size()[1]
        #     model = get_FeatureAlign_V2(in_ch, out_ch)
        #     #print('---big----', big_map.shape, '----samll--', small_map.shape)
        #     small_map = model(big_map, small_map)
        #     #print('---small--', small_map.shape)
        #     idx = idx - 1
        #
        #     if idx - 1 != -1:
        #         #print(idx - 1)
